export const Strings = {
  ...
  CREATED: "Created by: ",
  /**
   * View on tuli in proof of authenticity box
   * @default View on Tuli
   */
  VIEW_TULI: "View on Tuli",
  /**
  ...
  /**
   * CTA to go to tuli website to place a bid
   * @default Place bid
   */
  PLACE_BID: "Place bid",
  /**
   * CTA to go to tuli website to place an offer
   * @default Place offer
   */
